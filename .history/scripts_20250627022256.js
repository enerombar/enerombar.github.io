...
document.addEventListener('DOMContentLoaded', function() {
  ...
  if (canvas) {
    ...
    const waveConfig = [
        { amplitude: 25, frequency: 0.008, speed: 0.025, thickness: 1.5, opacity: 0.25 },
        { amplitude: 15, frequency: 0.012, speed: 0.015, thickness: 1, opacity: 0.2 },
        { amplitude: 35, frequency: 0.005, speed: 0.01, thickness: 2, opacity: 0.15 }
    ];

    function drawBrokenHexagon(cx, cy, radius) {
    ...
    function animate() {
      ...
      waveConfig.forEach(wave => {
          ctx.strokeStyle = `rgba(0, 234, 255, ${wave.opacity})`;
      ...
      drawBrokenHexagon(width / 2, height / 2, hexRadius);
      drawBrokenHexagon(width / 2, height / 2, hexRadius * 1.25);
