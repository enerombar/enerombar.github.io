...
document.addEventListener('DOMContentLoaded', function() {
  ...
  if (canvas) {
    ...
    function animate() {
      ...
      // 4. Draw multiple concentric irregular shapes with jumps (discontinuities)
      ...
      for (let i = 0; i < numShapes; i++) {
        ...
        ctx.strokeStyle = `rgba(0, 234, 255, ${0.10 + i * 0.05})`;
      ...
      // 5. Dibujar líneas onduladas horizontales adicionales para más dinamismo
      for (let l = 0; l < 3; l++) {
        ctx.save();
