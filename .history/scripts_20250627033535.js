...
function switchLanguage() {
  // Ya no es necesario cambiar cíclicamente, solo se mantiene para compatibilidad si se usa en otro lado
  // Esta función puede quedar vacía o simplemente llamar a updateLangFlag y applyTranslations
  updateLangFlag();
  applyTranslations();
}
