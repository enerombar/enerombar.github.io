...
document.addEventListener('DOMContentLoaded', function() {
  ...
  if (canvas) {
    ...
    function drawBrokenHexagon(cx, cy, radius, rotation = 0) {
    ...
    function animate() {
      ...
      drawBrokenHexagon(width / 2, height / 2, hexRadius, rotation);
      drawBrokenHexagon(width / 2, height / 2, hexRadius * 1.25, -rotation * 0.7);
